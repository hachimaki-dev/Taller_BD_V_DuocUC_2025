...
-- Definimos un tipo de RECORD personalizado
   type tipo_usuario is record ( --es un tipo de dato personalizado 'tipo_usuario' como si fuese por ejemplo varchar, date, etc
         nombre varchar2(100),
         email  varchar2(100),
         saldo  number(10,2),
         activo boolean
   );
-- Declaramos una variable que tenga ese tipo de dato
